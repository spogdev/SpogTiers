...
public final class HandCursors {
	...
	private static CursorType open;
	...
	private static void build() {
		...
		try {
			...
			// takes a handle: createStandardCursor only accepts one of GLFW's
	...
	private static CursorType make(Constructor<CursorType> ctor, String name, boolean grip)
