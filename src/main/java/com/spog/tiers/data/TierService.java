...
/**
 * Fetches tier data. PlayerEntity UUIDs are queued on the client thread and drained
...
public class TierService {
	...
	private void enqueueVisiblePlayers() {
		...
		if (client.world != null && client.player != null) {
			List<AbstractClientPlayerEntity> nearby = new ArrayList<>(client.world.getPlayers());
			nearby.sort(Comparator.comparingDouble(client.player::squaredDistanceTo));
